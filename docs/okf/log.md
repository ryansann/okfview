...
* **Update**: Documented persistence; see [JSON over SQLite](/decisions/json-not-sqlite.md).
* **Update**: Documented packaging, ad-hoc signing, and GitHub Release publishing; see [release process](/reference/release-process.md).
